...
return [
    ...
    'hello'  => '歡迎使用',
    'maccms_name'=>'v10',
    'maccms_copyright'=>'© shidaole All Rights Reserved.',
    ...
    'admin/system/configuser/trysee_tip'=>'全局設置無權限需要積分點播的試看時長，單位分鐘；0表示{:lang(\'close\')}全局試看；',
    ...
    'install/header'=>'感謝您選擇蘋果CMS-V10系搭建網站',
