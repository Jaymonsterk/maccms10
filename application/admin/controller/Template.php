...
class Template extends Base
{
    ...
    public function info()
    {
        ...
        $filter = '<\?|php|eval|server|assert|post|request|cookie|session|input|env|config|call|global|dump|print|phpinfo|fputs|fopen|global|chr|strtr|pack|system|gzuncompress|shell|base64|proc|preg|call';
