    ...
    var l = {
        ...
        appendItemsSizes: function() {
            ...
            a.$owlItems.each(function(c) {
                var d = f(this);
                d.css({
                    width: a.itemWidth / 2  /* width: a.itemWidth */
        ...
        appendWrapperSizes: function() {
            this.$owlWrapper.css({
                width: this.$owlItems.length * this.itemWidth / 2 , /* width: this.$owlItems.length * this.itemWidth * 2,*/
                left: 0
            });
        ...
        loops: function() {
            ...
            this.pagesInArray = [];
            for (e = 0; e < this.itemsAmount; e += 1) b += this.itemWidth / 2 , this.positionsInArray.push(-b), !0 === this.options.scrollPerPage && (c = f(this.$owlItems[e]), c = c.data("owl-roundPages"), c !== a && (this.pagesInArray[a] = this.positionsInArray[e], a = c))
        },
