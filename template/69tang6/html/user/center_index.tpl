  ...
  <div class="col-xs-12 ff-col">
    ...
    <dl class="safe">
      ...
      <dd>影币可用来支付付费点播影片或购买VIP权限 您现在拥有（{$user_score|default=0}）个影币
			<if condition="ff_PaymentItem()"><a href="javascript:;" class="btn btn-success btn-sm user-score-payment">在线充值</a></if>
			<if condition="C('pay_card_sell')"><a class="btn btn-sm btn-success user-score-card" href="javascript:;">卡密充值</a></if>
			</dd>  
      <dt>VIP权限</dt>
